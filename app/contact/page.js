...
const Contact = () => {
  return (
    <>
      <div className="bg-contact4 relative min-h-screen bg-black bg-cover bg-center bg-no-repeat text-gold-90">
        ...
        <div className="relative z-10 mx-auto w-11/12 max-w-screen-1.5xl">
          <div className="space-y-44   pb-32 pt-20">
            <div className="space-y-10">
              <h1 className="bg-gradient-to-b from-gold-90 to-yellow bg-clip-text text-center font-marcellus text-3xl font-black uppercase tracking-widest text-transparent lg:text-4xl">
                Services / Contact
              </h1>
